...
> = {
  today: {
    path: "/service/today",
    icon: Sparkles,
    iconBg: "bg-violet-500/10 text-violet-600 dark:text-violet-400/15 dark:text-violet-400",
    ringGradient: "from-violet-400/40 via-violet-300/30 to-transparent",
    title: "오늘의 운세",
  ...
  tarot: {
    path: "/service/tarot",
    icon: WalletCards,
    iconBg: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400/15 dark:text-indigo-400",
    ringGradient: "from-indigo-400/40 via-indigo-300/30 to-transparent",
    title: "타로",
  ...
  ohahasa: {
    ...
    ringGradient: "from-amber-400/40 via-amber-300/30 to-transparent",
    title: "오하아사",
...
const cardBase =
  ...
  "hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/[0.06] hover:border-indigo-200/50 " +
  "focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 " +
  "dark:shadow-black/5 dark:hover:border-indigo-500/20 dark:hover:shadow-indigo-950/10";
...
function ServiceCard({ service }: { service: ServiceSlug }) {
  ...
  return (
    <div className={`relative rounded-2xl p-[1px] bg-gradient-to-br ${config.ringGradient} dark:from-white/10 dark:via-white/5 dark:to-transparent`}>
      <Card
        role="button"
        tabIndex={0}
        onClick={handleClick}
        ...
        className={`${cardBase} border-0 rounded-2xl`}
      >
...
export function HomeServices() {
  return (
    <section
      id="services"
      className="py-6 md:py-8 px-4 scroll-mt-24"
      style={{ animation: "fade-in-up 0.5s ease-out 0.06s both" }}
    >
      <div className="max-w-5xl mx-auto rounded-3xl bg-white/60 dark:bg-white/5 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-sm py-6 md:py-8 px-6 md:px-8">
